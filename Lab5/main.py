...
def noise_reduction(input_file, output_file, frame_size=4096, overlap=0.5, noise_start=0, noise_end=3000, suppression_factor=3, protection_factor=0.0001):
...
noise_reduction('Lab5/tractor2.wav', 'Lab5/output.wav')
