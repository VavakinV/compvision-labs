...
# 1. Чтение изображения, перевод в чёрно-белый формат, размытие по Гауссу
# =================================================
...
# process_image("Lab4/input.png")


# 2. Расчёт матриц длин и углов градиентов пикселей
# =================================================
...
# mg, qa = process_image("Lab4/input.png")
